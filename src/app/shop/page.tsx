...
export function generateMetadata({ searchParams: { q } }: PageProps): Metadata {
  return {
    title: q ? `Search results for "${q}"` : "Products",
  };
}
...
const Page = async ({
  ...
  const title = q ? `Search results for "${q}"` : "Products";
...
const ProductResults = async ({
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex flex-col sm:grid grid-cols-2 gap-5 xl:grid-cols-3 2xl:grid-cols-4">
